#!/usr/bin/env python3
"""
AiLearno Course Generation Pipeline — Main CLI

Usage:
    # Generate prompts for a course
    python3 generate_pipeline.py prompts "course_id" "Course Name"
...
STAGING_DIR = "staging"
COURSES_DIR = "v1/courses"

def cmd_prompts(args):
    """Generate prompt files for AI agent to read."""
    course_id = args.course_id
    course_name = args.course_name
    print(f"\n📝 Generating prompts for course: {course_id} ({course_name})")
...
def main():
    parser = argparse.ArgumentParser(
        description="AiLearno Course Generation Pipeline",
    ...
    p_prompts.add_argument("course_name", help="Target Course Name (e.g. 'Ethical Hacking')")
